...
const features = [
  {
    ...
    body: "We create SureScreen (TM) - an AI clone trained on your hiring manager's expertise, tone, and the specific role requirements. It knows what great looks like, because it learned from someone who does.",
  },
  {
    icon: MessageSquare,
    title: "Deep, probing screening interviews",
    body: "SureScreen (TM) doesn't just ask surface questions. It cross-examines, challenges answers, and verifies resume claims in real time - something an overwhelmed recruiter rarely has time to do.",
  },
  {
    icon: CheckCircle2,
    title: "Screen candidates at any hour",
    body: "Candidates choose their own time - 6am, 10pm, whenever. No scheduling back-and-forth. No time zones. SureScreen (TM) is always ready, always consistent, never having a bad day.",
  },
  {
    icon: Star,
    title: "Ranked shortlist + feedback loop",
    body: "Every candidate who completes a SureScreen (TM) interview gets ranked by response quality. Your hiring manager reviews the top five - already screened - and meets only the best.",
  },
];
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center mb-12">
          ...
          <div className="order-1 lg:order-2">
            ...
            <h2 className="text-3xl sm:text-4xl font-semibold text-sage-900 mb-4 text-balance">
              SureScreen (TM) screens every candidate for you
            </h2>
            <p className="text-warm-600 leading-relaxed">
              SureScreen (TM) sits between your job ad and your calendar. Every
