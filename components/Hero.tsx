      ...
      <div className="max-w-6xl mx-auto">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div>
            <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-sage-100 text-sage-700 text-xs font-medium mb-6">
              <Sparkles size={12} />
              AI-powered candidate screening — coming soon
            </div>
            ...
            <p className="text-lg text-warm-700 leading-relaxed mb-8">
              ...
              misses outstanding people. SureScreen Recruit fixes this — an AI
              clone of your hiring manager interviews every applicant, ranks them
              by substance, and hands you the top five ready for a real conversation.
            </p>
        ...
        <div className="mt-16 grid grid-cols-2 sm:grid-cols-4 gap-6">
          {[
            ...
            { value: "24/7", label: "Interviews, no scheduling needed" },
