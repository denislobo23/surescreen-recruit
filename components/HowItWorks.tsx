const steps = [
  {
    step: "01",
    who: "You",
    title: "Set up your role & SureScreen™ clone",
    body: "Tell us about the role, the must-haves, the nice-to-haves, and what great really looks like. We configure your SureScreen™ clone with that expertise and your hiring manager's interview style.",
  },
  {
    step: "02",
    who: "Candidate",
    title: "Candidate applies & gets invited",
    body: "When someone applies via your job ad, they receive an invitation to complete a SureScreen™ screening interview — at any time of their choosing, from any device.",
  },
  {
    step: "03",
    who: "AI",
    title: "SureScreen™ conducts the interview",
    body: "The clone runs a structured, in-depth interview. It asks role-specific questions, cross-references their resume, probes for depth, and flags inconsistencies automatically.",
  },
  {
    step: "04",
    who: "AI",
    title: "Candidates are scored & ranked",
    body: "Every screening interview is scored on relevant dimensions — skills depth, clarity, honesty signals, cultural fit markers. Candidates are ranked from strongest to weakest.",
  },
  {
    step: "05",
    who: "You",
  ...
  },
  {
    ...
    body: "Every candidate who completed the SureScreen™ interview receives personalised feedback — what they did well, what to improve. A world first in volume hiring.",
  },
];
      ...
      <div className="max-w-6xl mx-auto">
        <div className="max-w-2xl mb-12">
          ...
          <p className="text-warm-600 leading-relaxed">
            Six steps. Two of them are yours. The rest is SureScreen™.
          </p>
        </div>
